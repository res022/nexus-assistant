...
def add_metadata_to_file(filepath, metadata):
    ...
    if "---METADATA---" in content:
        print(f"  Metadata already exists in {os.path.basename(filepath)}, replacing...")
        # Remove old metadata
